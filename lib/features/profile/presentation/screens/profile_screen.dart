...
class ProfileScreen extends ConsumerWidget {
            ...
            child: Column(
              children: [
                ...
                _buildMenuSection(context, 'Account Settings', [
                  _buildMenuItem(context, 'Personal Information', Icons.person_outline_rounded),
  ...
  Widget _buildMenuItem(BuildContext context, String title, IconData icon, {bool isSwitch = false}) {
    final theme = Theme.of(context);
    return ListTile(
